...
public class HttpUtils {
    ...
    private static final int MAX_TIMEOUT = 2000000;
   ...
   public static String doGetSSL(String url, Map<String, String> headers, Map<String, Object> params){
     ...
     * @return
     */
    public static String doPostHttp(String apiUrl, Map<String, String> headers, Map<String, Object> params,String proxyIp ) {
    	HttpHost proxy = new HttpHost(proxyIp, Integer.valueOf(8080),"http");
...
//        CloseableHttpClient httpClient = HttpClients.createDefault();
    ...
    public static String doPostHttp(String apiUrl, Map<String, String> headers, JSON params, String proxyIp ) {
        HttpHost proxy = new HttpHost(proxyIp, Integer.valueOf(8080),"http");
        requestConfig = requestConfig.custom().setProxy(proxy).build();
        CloseableHttpClient httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory()).setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
//        HttpPost httpPost = new HttpPost(apiUrl);
//        CloseableHttpClient httpClient = HttpClients.createDefault();
     ...
     * @return
     */
    public static String doPostSSL(String apiUrl, Map<String, String> headers, Map<String, Object> params, String proxyIp) {
    	HttpHost proxy = new HttpHost(proxyIp, Integer.valueOf(8080),"http");
        requestConfig = requestConfig.custom().setProxy(proxy).build();
        CloseableHttpClient httpClient = HttpClients.custom().setSSLSocketFactory(createSSLConnSocketFactory()).setConnectionManager(connMgr).setDefaultRequestConfig(requestConfig).build();
        HttpPost httpPost = new HttpPost(apiUrl);
...
//				}
    ...
    /**
     * 发送 SSL POST 请求（HTTPS），K-V形式  (新增代理端口参数)
     * @param apiUrl API接口URL

     * @param proxyPort
     * @return
     */
    public static String doPostSSL(String apiUrl, Map<String, String> headers, String param, String proxyIp,int proxyPort) {
...
//    	String url="http://www.baidu.com";
    	String poxid="192.168.10.200";
    	HashMap<String, Object> map = new HashMap<String, Object>();
    
    	String postSSL = doPostHttp(url, null, map,poxid);
    	System.out.print(postSSL);
